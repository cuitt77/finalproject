...
<head>
    <title>Title</title>
    <link rel="stylesheet" type="text/css" href="${app}/easyui/css/themes/ui-sunny/easyui.css">
    <link rel="stylesheet" type="text/css" href="${app}/easyui/css/themes/icon.css">
    <link rel="stylesheet" type="text/css" href="${app}/easyui/css/IconExtension.css">
    <script type="text/javascript" src="${app}/easyui/js/jquery.min.js"></script>
    <script type="text/javascript" src="${app}/easyui/js/jquery.easyui.min.js"></script>
    <script type="text/javascript" src="${app}/easyui/js/form.validator.rules.js"></script>
    <script type="text/javascript" src="${app}/easyui/js/easyui-lang-zh_CN.js"></script>
...
<script>
    ...
    $(function(){
        ...
        //初始化系统菜单
        $.post("${app}/menu/showAll",function(menus){

            $.each(menus,function(i,menu){

                var content = "<div style='text-align: center;'>";
                $.each(menu.child,function(j,child){
